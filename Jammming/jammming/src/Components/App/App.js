      ...
      <div>
        ...
        <div className="App">
          ...
          <div className="App-playlist">
            ...
            <Playlist name={this.state.playlistName} list={this.state.playlistTracks} onRemove={this.removeTrack} onNameChange={this.updatePlaylistName} onSave={this.savePlaylist} />
          </div>
        </div>
      </div>
    );
